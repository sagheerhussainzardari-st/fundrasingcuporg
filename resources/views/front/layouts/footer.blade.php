                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="{{ url('how-it-works') }}">What is crowdfunding?</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 m-auto me-0">
                    <ul>
                        ...
                        <li>
                            <a target="_blank" class="youTubeIcon" href="https://www.youtube.com/channel/UCdpvTllpmvv1niSoMn6frnA"><i class="fab fa-youtube"></i></a>
                        </li>
                        <li>
