        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 m-auto">
                    <img class="w-100" src="Assets/Images/financialEmergencyFundraising/financialEmergencyFundraisingImg01.jpg" alt="Assets/Images/financialEmergencyFundraising/financialEmergencyFundraisingImg01.jpg">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="medicalFundraising">
        <div class="container">
            <div class="col-lg-6 m-auto text-center">
                <h3><b>We are the leading platform for Financial Emergency Help fundraising</b></h3>
            </div>
            <div class="row mt-3">
                ...
                <div class="col-lg-4">
                    <div class="card bg-transparent border-0 border-end border-secondary rounded-0 text-center">
                        <div class="card-body">
                            ...
                            <p class="mb-0">financial emergency fundraisers per year</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="container">
            <div class="topFundraisers newFundraisers">
                <div class="col-lg-9 m-auto">
                    <h2>Trending financial emergency help fundraising</h2>
                    <div class="row">
