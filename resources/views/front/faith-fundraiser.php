        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 m-auto">
                    <img class="w-100" src="Assets/Images/faithFundraiser/faithFundraiserImg01.jpg" alt="Assets/Images/faithFundraiser/faithFundraiserImg01.jpg">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="topFundraisers newFundraisers">
                <div class="col-lg-9 m-auto">
                    <h2>Browse faith fundraisers</h2>
                    <div class="row">
