    ...
    <section class="discoverSection01 pb-0">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="w-100" src="Assets/Images/emergencyFundraising/emergencyFundraisingImg01.jpg" alt="Assets/Images/emergencyFundraising/emergencyFundraisingImg01.jpg">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="medicalFundraising">
        <div class="container">
            <div class="col-lg-6 m-auto text-center">
                <h3><b>We're the leader in online emergency fundraising</b></h3>
            </div>
            <div class="row mt-3">
                ...
                <div class="col-lg-3">
                    <div class="card bg-transparent border-0 border-end border-secondary rounded-0 text-center">
                        <div class="card-body">
                            ...
                            <p class="mb-0">emergency fundraisers per year</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                        ...
                        <div class="col-lg-6 m-auto">
                            <div class="card bg-transparent border-0">
                                <div class="card-body">
                                    ...
                                    <h4>Vegas strong after tragedy</h4>
                                    <p>
                                        More than 88,000 people from around the world came together to help the victims of the Las Vegas shooting. With $11 million raised, survivors are getting the support they need.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <img class="w-100" src="Assets/Images/emergencyFundraising/slider/slide01.jpg" alt="Assets/Images/emergencyFundraising/slider/slide01.jpg"></img>
                        </div>
                    </div>
                </div>
                <div class="slide">
                        ...
                        <div class="col-lg-6 m-auto">
                            <div class="card bg-transparent border-0">
                                <div class="card-body">
                                    ...
                                    <p>
                                        Days after surviving the Las Vegas shooting, Michella lost her family home to wildfire. Nearly 200 donors gave $23k, helping Michella and her parents get back on their feet.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <img class="w-100" src="Assets/Images/emergencyFundraising/slider/slider03.png" alt="Assets/Images/emergencyFundraising/slider/slider03.png"></img>
                        </div>
                    </div>
                </div>
                <div class="slide">
                    <div class="row">
                        <div class="col-lg-6 m-auto">
                            <div class="card bg-transparent border-0">
                                <div class="card-body">
                                    <h6>Start fundraising stories</h6>
                                    <h4>Rebuilding after the floods</h4>
                                    <p>
                                        When Hurricane Harvey hit, the Pruetts were among the thousands whose houses were damaged by flood waters. Friends and family raised $19k to help them move back home.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <img class="w-100" src="Assets/Images/emergencyFundraising/slider/slide02.jpg" alt="Assets/Images/emergencyFundraising/slider/slide02.jpg"></img>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="topFundraisers newFundraisers">
                <div class="col-lg-9 m-auto">
                    <h2>Trending in emergency fundraising</h2>
                    <div class="row">
