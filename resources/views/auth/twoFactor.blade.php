                            ...
                            <div class="w-100">
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div>
                                            <h5 class="text-primary"> Two Factor Verification</h5>
                                            <p class="text-muted">You have received an email which contains two factor login code.
                                                If you haven't received it, press <a href="{{ route('verify.resend') }}">here</a>.</p>
                                        </div>

                                        <div class="mt-4">
                                            <form class="form-horizontal" method="POST" action="{{ route('verify.store') }}">
                                                @csrf
                                                <div class="mb-3">
                                            ...
                                            <div class="mt-5 text-center">
                                                <p><a href="javascript:void(0)" onclick="event.preventDefault(); document.getElementById('logoutform').submit();"
                                                                    class="font-weight-medium text-primary">Logout</a></p>
