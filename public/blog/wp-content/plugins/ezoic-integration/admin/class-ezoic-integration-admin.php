...
class Ezoic_Integration_Admin {
	...
	public static function is_cloud_integrated() {
		...
		if ( ( $cloud_integrated && ! empty( $options['integration_type'] ) && ( $options['integration_type'] == "wp" || $options['integration_type'] == "ba" ) ) || ( ! $cloud_integrated && ! empty( $options['integration_type'] ) && $options['integration_type'] == "cloud" ) ) {
