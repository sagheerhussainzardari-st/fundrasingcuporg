...
//				array('class' => 'ez_hidden')
	...
	function ezoic_cdn_api_key_field() {
        ...
        <p class="description">
            You can find your <a href="https://pubdash.ezoic.com/settings?scroll=api_gateway" target="_blank">API key
	...
	function ezoic_cdn_domain_field() {
        ...
        <input type="text" name="ezoic_cdn_domain"
               value="<?php echo( esc_attr( Ezoic_Cdn::ezoic_cdn_get_domain() ) ); ?>"/>
        <p class="description">
